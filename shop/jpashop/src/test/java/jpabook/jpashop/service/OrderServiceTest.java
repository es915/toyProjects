...
public class OrderServiceTest {
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        // when
        orderService.order(member.getId(), book.getId(), orderCount); // 주문에 11권을 주문한다고 함 -> 재고는 10권으로 예외 발생
    ...
    public void 주문취소() throws Exception {
        ...
        // then
        Order getOrder = orderRepository.findOne(orderId);
        Assert.assertEquals("주문 취소치 상태는 CANCEL 이다.",  OrderStatus.CANCEL, getOrder.getStatus());
